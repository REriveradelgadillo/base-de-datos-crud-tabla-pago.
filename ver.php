...
<body>
	<a href="index.php">Inicio</a> | <a href="agregar.html">agregar</a> | <a href="cerrar_sesion.php">cerrar sesion</a>
	<br/><br/>
	...
	<table width='80%' border=0>
		...
		while($res = mysqli_fetch_array($result)) {		
			...
			echo "<td><a href=\"editar.php?id=$res[id]\">Editar</a> | <a href=\"borrar.php?id=$res[id]\" onClick=\"return confirm('¿Estás seguro de que quieres eliminar?')\">Eliminar</a></td>";		
		}
		?>
	</table>	
</body>
